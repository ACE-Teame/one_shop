<div class="main-fl">
    <div class="left-nav">
        <ul class="nav-1">
            ...
            <li><a href="home.php"><i class="iconfont icon-page"></i> 页面设置</a></li>
            <li><a href="settings.php"><i class="iconfont icon-settings"></i> 系统设置</a></li>
            <li><a href="logs.php"><i class="iconfont icon-logs"></i> 操作日志</a></li>
        </ul>
    </div>
</div>